...
public class AntMove : MonoBehaviour
{
    ...
    [SerializeField] public GameObject puz;
    [SerializeField] public GameObject antpic;
    ...
    IEnumerator OnMouseDown()
    {
        ...
        if (puz.GetComponent<BoxCollider2D>().OverlapPoint(transform.position))
        {
            lift();
        }
    ...
    private void lift()
    {
        ...
        item.SetActive(true);
        girl.GetComponent<SecondSceneSpace>().lock1 = false;
        puz.SetActive(false);
